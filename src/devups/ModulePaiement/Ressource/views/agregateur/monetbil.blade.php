    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 " style="border: 1px solid #c8eedb;height: 295px">
                <img src="img/monet.png" style="width: 90%;padding-top:20%">
            </div>
            <div class="col-md-7">
                <form class="form-group" method="POST" action="" style="border: 1px solid #9de0f6;padding: 20px;height: 295px">
                    ...
                    ?><div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong class="fa fa-exclamation"></strong>&ensp;&ensp; Votre service key n'est pas valide.
                    ...
                    ?><div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong class="fa fa-check"></strong>&ensp;&ensp; Votre service key a été enregistré avec success.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
